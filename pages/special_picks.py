...
with tab2:
    ...
    pg_pts,  pg_res  = score_perfect_group(person["perfect_group"], group_standings)
    fe_pts,  fe_res  = score_fav_eliminated(person["fav_eliminated"], group_standings)
    uq_pts,  uq_res  = score_underdog_qualifies(person["underdog_qualifies"], group_standings, real_qualifiers)
    eu_pts,  eu_res  = score_range(person["european_top4"], european_top4_actual)
